...
| `YAS_K_S_TAB`    | 0xf0047 | Shift-Tab (Backtab) |
| `YAS_K_C_HOME`   | 0xf0048 | Ctrl-Home |
| `YAS_K_C_END`    | 0xf0049 | Ctrl-End |
| `YAS_K_C_INS`    | 0xf004a | Ctrl-Insert |
| `YAS_K_C_DEL`    | 0xf004b | Ctrl-Delete |
| `YAS_K_C_PGUP`   | 0xf004c | Ctrl-PageUp |
| `YAS_K_C_PGDN`   | 0xf004d | Ctrl-PageDown |
| `YAS_K_S_HOME`   | 0xf004e | Shift-Home |
| `YAS_K_S_END`    | 0xf004f | Shift-End |
| `YAS_K_S_INS`    | 0xf0050 | Shift-Insert |
| `YAS_K_S_DEL`    | 0xf0051 | Shift-Delete |
| `YAS_K_S_PGUP`   | 0xf0052 | Shift-PageUp |
| `YAS_K_S_PGDN`   | 0xf0053 | Shift-PageDown |
| `YAS_K_A_HOME`   | 0xf0054 | Alt-Home |
| `YAS_K_A_END`    | 0xf0055 | Alt-End |
| `YAS_K_A_INS`    | 0xf0056 | Alt-Insert |
| `YAS_K_A_DEL`    | 0xf0057 | Alt-Delete |
| `YAS_K_A_PGUP`   | 0xf0058 | Alt-PageUp |
| `YAS_K_A_PGDN`   | 0xf0059 | Alt-PageDown |
| `YAS_K_KP5`      | 0xf005a | Keypad 5 with NumLock off |

F13-F20 (sent by the Linux console and some other terminals for Shift-F1 to Shift-F8) are reported as `YAS_K_S_F1` to `YAS_K_S_F8`.
...
| `YAS_K_A_C_H`    | Alt-Backspace on terminals where Backspace sends ^H |
| `YAS_K_A_TAB`    | Alt-Tab (if not used by the window manager) |
| `YAS_K_A_RET`    | Alt-Enter |
| `YAS_K_A_SPACE`  | Alt-Space |
...
| `YAS_K_A_y`      | Alt-y |
| `YAS_K_A_z`      | Alt-z |
| `YAS_K_A_A`      | Alt-Shift-a |
| `YAS_K_A_B`      | Alt-Shift-b |
| `YAS_K_A_C`      | Alt-Shift-c |
| `YAS_K_A_D`      | Alt-Shift-d |
| `YAS_K_A_E`      | Alt-Shift-e |
| `YAS_K_A_F`      | Alt-Shift-f |
| `YAS_K_A_G`      | Alt-Shift-g |
| `YAS_K_A_H`      | Alt-Shift-h |
| `YAS_K_A_I`      | Alt-Shift-i |
| `YAS_K_A_J`      | Alt-Shift-j |
| `YAS_K_A_K`      | Alt-Shift-k |
| `YAS_K_A_L`      | Alt-Shift-l |
| `YAS_K_A_M`      | Alt-Shift-m |
| `YAS_K_A_N`      | Alt-Shift-n |
| `YAS_K_A_O`      | Alt-Shift-o; defined for completeness but cannot be received, because `\eO` is a key sequence prefix |
| `YAS_K_A_P`      | Alt-Shift-p |
| `YAS_K_A_Q`      | Alt-Shift-q |
| `YAS_K_A_R`      | Alt-Shift-r |
| `YAS_K_A_S`      | Alt-Shift-s |
| `YAS_K_A_T`      | Alt-Shift-t |
| `YAS_K_A_U`      | Alt-Shift-u |
| `YAS_K_A_V`      | Alt-Shift-v |
| `YAS_K_A_W`      | Alt-Shift-w |
| `YAS_K_A_X`      | Alt-Shift-x |
| `YAS_K_A_Y`      | Alt-Shift-y |
| `YAS_K_A_Z`      | Alt-Shift-z |
